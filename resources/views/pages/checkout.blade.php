...
<link rel="stylesheet" type="text/css" href="{{ asset('public/frontend/styles/cart_responsive.css') }}">
	...
	<div class="cart_section">
		...
		<li class="cart_item clearfix">
			<div class="cart_item_image text-center"><br><img src="{{URL::to($row->options->image1)}}"  style="width: 70px; width: 70px;" alt=""></div>
	 ...
	 <a href="{{ url('remove/cart/'.$row->rowId ) }}" class="btn btn-sm btn-danger">x</a>
                        ...
                        <form method="post" action="{{route('apply.coupon')}}">
                            ...
                            <div class="form group col-lg-4">
                                <input type="text" name="coupon" class="form-control" required="" placeholder="Apply Your Coupon">
                            </div><br>
