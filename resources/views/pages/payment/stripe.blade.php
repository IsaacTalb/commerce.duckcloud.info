...
<link rel="stylesheet" type="text/css" href="{{asset('public/frontend/styles/contact_responsive.css')}}">
        ...
        <li class="cart_item clearfix">
            ...
            <div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
                 ...
                 <div class="cart_item_name cart_info_col">
                    ...
                    <div class="cart_item_text"><img src="{{ asset($row->options->image1) }} " style="width: 70px; width: 70px;" alt=""></div>
                </div>
           ...
           <span style="float: right;">{{ Session::get('coupon')['discount'] }} $</span> </li>
            ...
            @if(Session::has('coupon'))
          						<li class="list-group-item">Total : <span style="float: right;">{{(int) Session::get('coupon')['balance'] +(int) $charge + $vat }}$ </span> </li>
          						@else
      							<li class="list-group-item">Total : <span style="float: right;">{{ (int)Cart::Subtotal() +(int) $charge + $vat }} $</span> </li>
          						@endif
  ...
  <input type="hidden" name="payment_type" value="{{ $data['payment'] }} ">
   ...
   var stripe = Stripe('pk_test_51JLtNmGQ9YOHizoj0veAWd0QKsdF80DEUfLQSFEPhKGMXN8l2OosnGzgQWFWaXbMwgEwlYqn3guoJ43zScsoP3ge00fkMoh0GN');
